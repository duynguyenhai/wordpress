...
function WordPress_MagicZoom_send_stat($action = '') {
    ...
    if('working' == 'v5.12.2' || 'working' == 'v4.5.24') {
        return;
    }
    ...
    $path = "api/stat/?action={$action}&tool_name=magiczoom&license=trial&tool_version=v4.5.24&module_version=v5.12.2&platform_name=wordpress&platform_version={$platformVersion}&url={$url}";
